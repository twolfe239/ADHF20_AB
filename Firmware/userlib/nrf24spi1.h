#ifndef __NRF24SPI1_H
#define __NRF24SPI1_H
...
#define nRF24_CE_L()               HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_RESET)
#define nRF24_CE_H()               HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_SET)
// CSN (chip select negative) pin 
#define nRF24_CSN_PORT             GPIOA
#define nRF24_CSN_PIN              GPIO_Pin_4
#define nRF24_CSN_L()              HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET)
#define nRF24_CSN_H()              HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET)
